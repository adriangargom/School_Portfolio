...
/*  Queri 2 - Use of subqueries in the various sections of a query: SELECT, FROM and WHERE.
...
/*  Queri 3 - Multiple JOIN type combinations at once.
...
/*  Queri 4 - Multiple JOIN type combinations at once | Use one of the clauses: UNION, INTERSECT and EXCEPT.
...
/*  Queri 5 - Using multiple tables at the same time in the FROM | Use of subqueries in the various sections of a query: SELECT, FROM and WHERE.
...
/*  Queri 6 - Use one of the clauses: UNION, INTERSECT and EXCEPT.
...
/*  Queri 7 - Use one of the clauses: UNION, INTERSECT and EXCEPT.
...
/*  Queri 8 - Multiple JOIN type combinations at once | Show sorted data.
...
/*  Queri 9 - Multiple JOIN type combinations at once | Show sorted data.
...
/*  Queri 10 - Multiple JOIN type combinations at once
...
/*  Queri 10 - Multiple JOIN type combinations at once | Show sorted data.
...
/*  Queri 11 - Multiple JOIN type combinations at once | Show sorted data.
...
/*  Queri 12 - Multiple JOIN type combinations at once
...
/*  Queri 13 - Multiple JOIN type combinations at once
...
/*  Queri 14 - Multiple JOIN type combinations at once
...
/*  Queri 15 - Multiple JOIN type combinations at once | Show sorted data.
...
/*  Queri 16 - Multiple JOIN type combinations at once
...
CALL selAll('game' , 1);
CALL selAll('pokemon',null);
CALL selAll('generation',33);
