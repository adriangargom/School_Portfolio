...
public class DwarfOrder extends Dwarf implements InterfaceOrder, InterfaceColors{

    public DwarfOrder(String name, int strength, int constitution, int velocity, int intelligence, int luck, Weapon weapon, int statPoints){
