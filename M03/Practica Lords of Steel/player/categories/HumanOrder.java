...
public class HumanOrder extends Human implements InterfaceOrder, InterfaceColors{
    
    public HumanOrder(String name, int strength, int constitution, int velocity, int intelligence, int luck, Weapon weapon, int statPoints){
