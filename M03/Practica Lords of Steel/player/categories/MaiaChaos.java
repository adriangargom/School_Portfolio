...
public class MaiaChaos extends Maia implements InterfaceChaos, InterfaceColors {
    
    public MaiaChaos(String name, int strength, int constitution, int velocity, int intelligence, int luck, Weapon weapon, int statPoints){
