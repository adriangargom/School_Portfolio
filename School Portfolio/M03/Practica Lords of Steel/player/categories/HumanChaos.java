...
public class HumanChaos extends Human implements InterfaceChaos, InterfaceColors {
    
    public HumanChaos(String name, int strength, int constitution, int velocity, int intelligence, int luck, Weapon weapon, int statPoints){
