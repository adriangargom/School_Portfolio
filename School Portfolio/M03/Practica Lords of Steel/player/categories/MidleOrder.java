...
public class MidleOrder extends Midle implements InterfaceOrder, InterfaceColors{
    
    public MidleOrder(String name, int strength, int constitution, int velocity, int intelligence, int luck, Weapon weapon, int statPoints){
